...
if (fs.existsSync('./M-A-C-T-R-I-X/M-A-C-T-R-I-X/blob/main/Themes/' + Config.LANG + '.json')) {var json = JSON.parse(fs.readFileSync('./M-A-C-T-R-I-X/M-A-C-T-R-I-X/blob/main/Themes/' + Config.LANG + '.json'));} 
else {	var json = JSON.parse(fs.readFileSync('M-A-C-T-R-I-X/M-A-C-T-R-I-X/blob/main/Themes/PRESIDENT-MD.json'));	}	
