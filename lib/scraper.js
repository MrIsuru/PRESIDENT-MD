...
if (fs.existsSync('github.com/M-A-C-T-R-I-X/M-A-C-T-R-I-X/blob/main/Themes/' + Config.LANG + '.json')) {var json = JSON.parse(fs.readFileSync('github.com/M-A-C-T-R-I-X/M-A-C-T-R-I-X/blob/main/Themes/' + Config.LANG + '.json'));} 
else {	var json = JSON.parse(fs.readFileSync('github.com/M-A-C-T-R-I-X/M-A-C-T-R-I-X/blob/main/Themes/PRESIDENT-MD.json'));	}	
